...
@media (max-width: 768px) {
  ...
  <!--style="background-image:url(images/xbg.jpg.pagespeed.ic.tiVxeakBSd.webp)"-->
				   ...
				   <!--  <img src="images/Middle_banner2.png" class="img-responsive" alt="-2022-" style="background-size: cover;background-repeat: no-repeat;height:50px;width: 100%;">
				    ...
				    <h3 class="text-center my-2" style="font-size:25px; font-weight:700; color:#fff;">-2022-</h3>
							...
							<div class="signup-form">
					            ...
					            <form id="rag2020-form"  method="post" autocomplete="on" enctype="multipart/form-data" action="stu_login_op.php">           
					            <!-- SECTION 1 -->
					            <div class="form-group top-section2 text-center" id="paragrp"> 			
					                <h4 class="mandatory-heading" id="top_heading"><b>मार्कशीट और अन्य विवरण अपलोड करने के लिए कृपया लॉग इन करें।<br /><span class="mandatory-heading">PLEASE LOGIN FOR UPLOADING MARKSHEET & OTHER DETAILS(<span class="main-req-col">*</span>)!</span></b></h4>
					                <hr class="text-dark">
					                <p class="mb-4 text-center text-dark" >कृपया अपना रेजिस्टर्ड  ईमेल आईडी और अंतिम 7 अंकों का <b>यूनिक रोल नम्बर</b> दर्ज करें |(जैसे:
		                      <b>0000001</b> पंजीकरण संख्या फ़ील्ड पर)<br>Please enter your registered Email ID & last 7 digits of <b>Unique Roll Number</b> (Like:
					                	<b>0000001</b>).</p>
									  		<hr class="text-dark">
								       </div>
				                        ...
				                        <?php  unset($_SESSION['msg']);}?>
										          ...
										          <div class="card-body p-5 text-center">
										            ...
										            <div class="form-outline mb-2">
										              ...
										              <!-- <label class="form-label" for="typeEmailX-2">Email id</label> -->
										            </div>
										            ...
										            <div class="form-outline mb-2">
										            	...
										            	<input type="stu_reg_id" id="stu_reg_id" name="stu_reg_id" class="form-control  form-control-lg"   />
