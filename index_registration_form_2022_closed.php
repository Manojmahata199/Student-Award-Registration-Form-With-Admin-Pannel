          ...
          $duplicate_msg="Student You Have Allready Registered With us.You Can Not Do Registration Again.Contact Us For Any Changes In Your Details"; 
										...
										<tr>
											...
											<td valign="top">
												...
												<tr><th colspan="2"><h4>
												  ...
												  <span class="hindi-label" style="text-align: center;align-content: center;align-items: center;">(स्वीकृत प्रपत्र)</span><br/><span class="eng-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Unique Roll Number:<span class="high-light">T-'.$boardName.'-'.$row["reg_id"].'</span></span><br><span class="hindi-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     (यूनिक रोल नंबर)</span></h4></th></tr>
										        <br>  <br>  <br>  
												...
												<tr><td><span class="hindi-label">इमरजेंसी दूरभाष नंबर</span></td><td rowspan="2"><span class="eng-label">'.$row["emergency_landline"].'</span></td></tr>
												...
												<tr><td><span class="hindi-label">फेसबुक हैंडल</span></td><td rowspan="2"><span class="eng-label">'.$row["facebook_handle"].'</span></td></tr>
												<tr><td><span class="eng-label">Facebook Handle</span></td></tr>
												<tr><td><span class="hindi-label">इंस्टाग्राम हैंडल</span></td><td rowspan="2"><span class="eng-label">'.$row["twitter_handle"].'</span></td></tr>
				...
				// SanRag@9812sx
						   ...
						   $mail->AddStringAttachment($emailAttachment,'ragp-form-2022.pdf','base64','application/pdf');		 
				            ...
				            if(!$mail->send()) {
				                $display_msg= 'पंजीकरण के लिए धन्यवाद छात्र<br>Thank You Student For Registration ';
	     ...
	     <!--   <div class="navbar" style="text-align:center;align-content: center;align-items: center;">-->
			...
			<div class="signup-form">
		            ...
		            <div class="form-group top-section2" id="fill_section"> 			
		                <h4 class="mandatory-heading"><b>छात्रों से सभी अनिवार्य (<span class="main-req-col">*</span>) फ़ील्ड भरने की विनती।<br /><span class="mandatory-heading">REQUESTING STUDENTS TO FILL ALL MANDATORY (<span class="main-req-col">*</span>) FIELDS.</span></b></h4>
					</div>
                ...
                <hr>
				<h3 class="section-heading sub-heading text-center py-3 text-light" style="background-color:#ae2627;font-size:15px; font-weight:700; color:#fff;"><span class="heading1-hindi">छात्र अपनी श्रेणी का चयन करें</span><br/><span class="heading1-eng">STUDENT SELECT YOUR CATEGORY</span></h3>
				<hr>
                <div class="form-row">					
                   ...
                   <p class="para-hindi"><span class="req-col"></span> जिन बच्चो ने किसी भी शारीरिक या मानसिक चुनौतियों का अनुभव किया है , वे 'हाँ'' का चयन करें (स्थिति परीक्षा की तारीख से कम से कम 45 दिनों के पहले से मौजूद  होनी चाहिए|)</p>
				   <p class="para-eng">Select 'Yes' for children who have experienced any physical or mental challenges (The condition should have been present for a minimum of 45 days before the date of exam.)</p>
					...
					<div class="aparajay-section" style="display:none;">
						 <p class="para-hindi"><span class="req-col"></span>उन बच्चों के लिए जिन्होंने किसी भी शारीरिक या मानसिक चुनौतियों का अनुभव किया है (स्थिति परीक्षा की तारीख से कम से कम 45 दिन पहले मौजूद होनी चाहिए ।)</p>
						...
						<div class="flex-aparajay col-md-12 bg-light">
						    <div class="form-row col-md-4">                        
			                    	<label for=""><span class="label-hindi">दिव्यांगता का चयन  करें</span><span class="req-col text-danger">*</span><br><span class="label-eng">Please Select Disorder</span></label>
			                    	<div class="form-group">
									<div>   
			                    		<select name="disorder" id="disorder" class="form-select" aria-label="Default select example">
		                                	<option value="">कृपया अपना विकार चुनें/Please Select Disorder</option>
	                        ...
	                        <div class="physical-option-section col-md-4" style="display:none;">
								<div class="form-row">
								  	<label for=""><span class="label-hindi">कृपया शारीरिक समस्या का चयन करें </span><span class="req-col text-danger">*</span><br /><span class="label-eng">Please Choose Physical Challenge Undergone</span></label>
			                    	<div class="form-group">
									<div>
			                    		<select name="phy_disorder_name" id="phy_disorder" class="form-select" aria-label="Default select example">
		                                	<option value="">शारीरिक विकार/Physical Disorder</option>									
                               ...
                               <!-- mental selection option ---> 
	                            <div class="mental-option-section col-md-4" style="display:none;">
									 <div class="form-row">
				                    	...
				                    	<label for=""><span class="label-hindi">कृपया मानसिक समस्या का  चयन करें </span><span class="req-col text-danger">*</span><br /><span class="label-eng">Please Choose The Mental Challenge Undergone</span></label>
				                    	  	<div class="form-group">
											<div>
					                    		<select name="mental_disorder_name" id="mental_disorder" class="form-select" aria-label="Default select example">
					                                <option value="">मानसिक विकार/Mental Disorder</option> 
                        ...
                        <div class="apa-section-text">
	                        <p class="para-hindi">कृपया समस्या का संक्षिप्त उल्लेख करें और उससे संबंधित दस्तावेज अपने स्कूल के प्रिंसिपल से सत्यापित करवा कर संलग्न करें <span class="req-col text-danger">*</span></p>
						...
						<div class="form-row">						
		                    	<label for=""><span class="label-hindi">फ़ाइल प्रारूप और आकार - * .pdf, * .jpg, * .png,*.jpeg,*.jfif, अधिकतम 1 एमबी</span><span class="req-col text-danger">*</span><br /><span class="label-eng">Please upload relevant documents file format & size - *.pdf, *.jpg, *.png,*.jpeg,*.jfif, max. 1 MB</span></label>
		                    	<div class="my-2">
                  ...
                  <!--  <div class="form-row">
                   ...
                   <!-- SECTION 1 -->	               
                    ...
                    <label for="" class="radio-label"><span class="label-hindi">क्या आपके नाम की हिंदी वर्तनी सही है ?</span><span class="req-col text-danger">*</span><br><span class="label-eng">The name shown above in Hindi is correct?</span></label>
					...
					<!-- Location -->
						...
						<div class="form-row school-section flex_div">
		                    <div class="form-group col-md-6">
									...
									<label for=""><span class="label-hindi">रजिस्ट्रेशन (परीक्षा क्षेत्र)</span><span class="req-col text-danger">*</span><br><span class="label-eng">Registering For (Location)</span></label>
									<div class="">
                         ...
                         <!-- <div class="form-row">
		                   ...
		                   <p class="button btn btn-danger btn-lg my-3">Step-5</p><hr>
		                    ...
		                    <div class="School_teacher_details" >
							    <div class="form-row col-md-12 flex_div"> 
							        <div class="form-group col-md-6">
										<label for=""><span class="label-hindi">हिंदी शिक्षक का नाम</span><span class="req-col text-danger">*</span><br><span class="label-eng">Hindi Teacher Name</span></label>
       ...
       <!--                 <div class="form-row col-md-12 d-flex">-->
	      ...
	      <!--              </div> -->
                    ...
                    <section id="Step-6" class="section6">
                        ...
                        <div class="form-row">							
	                    	<label for=""><span class="label-hindi">आपको राम अवतार गुप्त प्रोत्साहन 2022 के बारे में कैसे पता चला?</span><span class="req-col text-danger">*</span><br /><span class="label-eng">How did you get to know about Ram Awatar Gupt Protsahan 2022?</span></label>
	                    	<div class="form-group">
								<div class="">
                   ...
                   <!--- Section 6 ----->
                    <hr>
                       <h3 class="section-heading sub-heading text-center py-3 text-light" style="background-color:#ae2627;font-size:15px; font-weight:700; color:#fff;"><span class="heading1-hindi">पुरस्कार के बारे में जानकारी</span><br /><span class="heading1-eng">AWARD DETAILS</span></h3>
                    <hr>

                     <div class="form-row  ragparticipated" style="display:none" style="margin-bottom: 50px;">
						<div class="form-radio">
	                    	<label for="" class="radio-label"><span class="label-hindi">क्या आपने राम अवतार गुप्त प्रतिभा पुरस्कार के लिए कक्षा 10 में भाग  लिया था?</span><span class="req-col text-danger">*</span><br /><span class="label-eng">Did you participate in Ram Awatar Gupt Pratibha Puraskar in class 10?</span></label>
	                    	<div class="form-row d-flex">
		                    	<div class="form-radio-item mx-4">
										<label class="">
				   ...
				   <!--- ANKUR BLOCK ---->
				   <div class="form-row">							
	                    	<label for=""><span class="label-hindi">    अंकुर पुरस्कार - क्या आपने किसी पाठ्यक्रमोत्तर (extra-curricular) हिंदी गतिविधियों में भाग लिया है ?
				   ...
				   <div class="ankur-option-section" style="display:none" style="margin-bottom: 50px;">
	                   <div class="ankur-activity-block"> <!-- block started--->                    
		                    <p class="para-hindi">कृपया मार्च 2018 से मार्च 2022 के बीच हिंदी के क्षेत्र में आपके द्वारा किए गए पाठ्येतर  कार्यों पर 200 शब्द लिखें<span class="req-col text-danger">*</span></p>                  
                  ...
                  <!--  <section class="student_skill" style="display:none;">
                   ...
                   <!--  <div class="form-row">
					...
					<hr>
					<p class="para-hindi"><span class="label-hindi">छात्र आपने फॉर्म भरने का भाग सफलतापूर्वक पूरा कर लिया है, आपसे अनुरोध है कि अपनी अंतिम समीक्षा के लिए <b>[प्रीव्यू बटन]</b> पर क्लिक करके सभी सम्मिलित विवरणों की जांच करें, यदि विवरण में कोई बदलाव आवश्यक है तो <b>[प्रीवियस बटन]</b> दबाएं और परिवर्तन करें। एक बार <b>[सबमिट बटन]</b> पर क्लिक करने के बाद आप अपना विवरण संशोधित नहीं कर सकते।</span></p><p class="para-hindi"><span class="label-hindi"> कृपया यह भी ध्यान दें कि पंजीकरण प्रक्रिया के दौरान पूछे गए सभी विवरणों का उपयोग छात्र की प्रामाणिकता की जांच के लिए किया जाएगा। यदि कोई अमान्य डाटा या अनुपयुक्त फाइल छात्र द्वारा अपलोड की गई है तो उसे अयोग्य घोषित कर दिया जाएगा।</span></p>
					...
					<div class="form-row">
					<label><span class="label-hindi">हिंदी शिक्षक का नाम*</span><span class="req-col text-danger">*</span><br /><span class="label-eng">Hindi Teacher Name</span></label>
					...
					<hr>
					<div class="form-row">
					<label><span class="label-hindi">आपको राम अवतार गुप्त प्रोत्साहन की जानकारी कहाँ से मिली?</span><span class="req-col text-danger">*</span><br /><span class="label-eng">How did you get to know about Ram Awatar Gupt Protsahan-2022?</span></label>
					...
					<!--</div>-->
					<h2>पुरस्कार के बारे में जानकारी/Award Details</h2>
					<!-- <div class="form-row">
					...
					<label><span class="label-hindi">क्या आपने राम अवतार गुप्त प्रतिभा पुरस्कार के लिए कक्षा 10 भाग में लिया था?</span><span class="req-col text-danger">*</span><br /><span class="label-eng">Have you participated in Ram Awatar Gupt Pratibha Puraskar in class 10?</span></label>
					<span id="regragpp10" class="stu-pre-value text-success" style="background-color: #ffeda9; color: #0b891b;"> </span>
					</div>
					<div class="form-row">
					<label><span class="label-hindi">अंकुर पुरस्कार-</span><span class="req-col text-danger">*</span><br /><span class="label-eng">Ankur Award-</span></label>
					<span id="regankuroption" class="stu-pre-value text-success" style="background-color: #ffeda9; color: #0b891b;"> </span>
					</div>					
					<div class="form-row">
					<label><span class="label-hindi">मार्च (2018 - 2022) के बीच हिंदी के क्षेत्र में आपके द्वारा किए गए पाठ्येतर कार्यों पर 200 शब्द लिखें</span><span class="req-col text-danger">*</span><br /><span class="label-eng">Extracurricular work done in the field of Hindi between March (2018 - 2022)</span></label>
