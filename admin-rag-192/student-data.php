            ...
            <div id="page-inner">
                <div class="row">
					...
					<?php
							...
							$sql = "SELECT * FROM `student_data` WHERE `reg_id`='$stuid'";
					...
					?>
						...
						<tr>
					   <td><b>Student Full Details :</b><a href="../uploads/<?php echo 'file'.$row['id'].'.pdf';?>" target="_blank">Click to Open</a></td>
						<td><b>Registration Location :</b><?php echo $row['reg_location']?></td>
						<td><b>Board :</b><?php echo $row['boardexam']?></td>
						</tr>
						<tr>
						<td><b>Student Category :</b><?php echo $row['category']?></td>
						<td><b>Disorder :</b><?php echo $row['disorder']?></td>
						<td><b>Physical Disorder :</b><?php echo $row['phy_disorder_name']?></td>
						</tr>
						<tr>
						<td><b>Mental Disorder :</b><?php echo $row['mental_disorder_name']?></td>
						<td><b>Disorder Details :</b><?php echo $row['disorder_detail']?></td>
						<td><b>Disorder File Attach :</b><?php echo $row['disorder_file']." ";?>

						<?php if($row['disorder_file']!=""){ ?>

                  <a href="../uploads/<?php echo $row['id']?>/disorder-img/<?php echo $row['disorder_file']?>" target="_blank">Click to Open</a>
						<?php }else{ ?>
              ...
              <?php if($row['hname_file']!=""){ ?>
                  ...
                  <a href="../uploads/<?php echo $row['id']?>/hindi-name/<?php echo $row['hname_file']?>" target="_blank">Click to Open</a>
						<?php }else{ ?>
                 ...
                 <a href="#">No File Uploaded</a>
                   ...
                   <a href="../uploads/<?php echo $row['id']?>/student-photo/<?php echo $row['student_photo_file']?>" target="_blank">Click to Open</a>
						<?php }else{ ?>
                 ...
                 <a href="#">No File Uploaded</a>
					  ...
					  <?php 	} ?>
						...
						<tr>						
						<td><b>Student DOB :</b><?php
						echo $row['student_dob'];?></td>
                   ...
                   <a href="../uploads/<?php echo $row['id']?>/admit-card/<?php echo $row['admit_card_file']?>" target="_blank">Click to Open</a>
						<?php }else{ ?>
                 ...
                 <a href="#">No File Uploaded</a>
					...
					<!-- 	<td><b>Last Year 3rd Term Marks :</b><?php echo $row['last_year_marks3']?></td> -->
					   ...
					   <td><b>Hindi Teacher Phone No :</b><?php echo $row['hnd_tech_mob']?></td>
						...
						<td><b>Emergency No :</b><?php echo $row['emergency_landline']?></td>
						...
						<tr>
							...
							<td><b>Facebook Handle :</b><?php echo $row['facebook_handle']?></td>
						<td><b>Instagram Handle :</b><?php echo $row['twitter_handle']?></td>
						<td><b>Sanmarg Reader :</b><?php echo $row['sanmarg_reader']?></td>
						</tr>
						<tr>
						
						<td><b>RAGPP Source :</b><?php echo $row['ragaward_source']?></td>
						<td><b>RAGPP Other Source :</b><?php echo $row['ragaward_source_other']?></td>
						 <td><b>Ankur:</b><?php echo $row['ankur']?> </td>
						
						</tr>
						<tr>
						
						
						<td><b>Ankur Details :</b><?php echo $row['ankur_activity_textwork']?></td>
						<td><b>Ankur File Name :</b><?php echo$row['ankur_activity_file']." ";?>



						 <?php if($row['ankur_activity_file']!=""){ ?>

                   <a href="../uploads/<?php echo $row['id']?>/ankur-activity/<?php echo $row['ankur_activity_file']?>" target="_blank">Click to Open</a>
						<?php }else{ ?>
                 ...
                 <a href="#">No File Uploaded</a>
                   ...
                   <a href="../uploads/<?php echo $row['id']?>/marksheet_img/<?php echo $row['marksheet_file']?>" target="_blank">Click to Open</a>
						<?php }else{ ?>
