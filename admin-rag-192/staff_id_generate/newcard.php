...
#id {
   ...
   background: url('../assets/img/certificate_new.jpg');  /* if you want to change the background image replace logo.png */  /*variable one for image*/
		            ...
		            <div id="id">
                            ...
                            <!-- to show image on the card  -->
                             ...
                             <div class="container front"  id="roll_no">
                                <h3 class="text-center text-dark"><b><?php echo $row['reg_id']; ?></b></h3>
                            ...
                            <div class="container text-center" id="name">
                                <h1 class="text-center text-dark" ><b><?php echo $row['winner_name']; ?></b></h1>
                                
                             </div>
                             <div class="container text-center d-flex" id="class_board">
                                 <div class="container text-center d-flex">
                                    <h2 class="text-center text-dark"><b><?php echo $row['winner_class']; ?></b></h2>
                                     
                                 </div>
                                 <div class="container text-center d-flex">
                                    <h2 class="text-center text-dark"><b><?php echo $row['winner_board']; ?></b></h2>
